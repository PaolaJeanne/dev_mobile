package com.example.Appgalerie
...
import com.example.Appgalerie.ui.theme.MyApplicationTheme
...
fun GreetingSpaceArt(modifier: Modifier =Modifier){
    ...
    val artworks = listOf(
        Artwork(R.drawable.oip, "Les miserables", "Victor Hugo", "1855"),
        Artwork(R.drawable.oip__1_, "Le journal d'Anne Frank ", "Paola", "1999"),
        Artwork(R.drawable.oip__2_, "Les soeurs d'Auschwitz ", "Ken Follett", "2015"),
